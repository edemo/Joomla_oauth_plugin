...
class adaloginTest extends PHPUnit_Framework_TestCase {
	...
	public function test_getLoginURI_correctly(){
		...
		$this->assertEquals(
			"https://adatom.hu/ada/v1/oauth2/auth?response_type=code&client_id=APP_ID_COMES_HERE&redirect_uri=https%3A%2F%2Flocalhost%3A8080%2Fcomponents%2Fcom_adalogin%2Findex.php",
			$resp);
