<?php
/**
 * @version		$Id:controller.php 1 2016-11-08Z FT $
 * @author	   	Fogler Tibor
 * @package    Adalogin
...
class AdaloginController extends JControllerLegacy
{
	...
	function save() 
	{
		...
		{
			case 'apply':
				$link = 'index.php?option=com_adalogin&view='.$this->_viewname.'&task=edit&cid[]='.$model->getId() ;
				break;

			case 'save':
			default:
				$link = 'index.php?option=com_adalogin&view='.$this->_viewname;
				break;
		}
